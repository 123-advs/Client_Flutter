class TestWritingMo {
  ...
  factory TestWritingMo.fromJson(Map<String, dynamic> json) {
    return TestWritingMo(
      id: json['_id'] ?? '',
...
class Answer {
  ...
  factory Answer.fromJson(Map<String, dynamic> json) {
    return Answer(
      answer: json['answer'],
      result: json['result'],
      term: TermW.fromJson(json['term']), // Sử dụng TermW trực tiếp
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      'answer': answer,
      'result': result,
      'term': term.toJson(), // Gọi phương thức toJson() cho đối tượng term
    };
  }
}
